...
#define MIDI_VELOCITY_ON 100
#define MIDI_VELOCITY_OFF 64

// ?Feel guitarra?
#define STRUM_GAP_MS  10     // 8?15ms recomendado
#define NOTE_LEN_MS   180    // 150?250ms recomendado
...
// NUEVO: rasgueo => agenda NOTE ON escalonados + NOTE OFF con duración estándar
void strumChord(const ButtonChord *chord, uint8_t velocity, uint32_t now_ms)
{
    ...
    // airbag opcional (si estás haciendo stress test y querés evitar colgadas):
    // midiAllNotesOff(MIDI_CH);
